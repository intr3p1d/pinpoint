...
public enum HbaseTable {
    ...
    MAP_STATISTICS_OUTBOUND_SERVICE_GROUP("ServiceGroupMapStatisticsOutbound"),
    MAP_STATISTICS_INBOUND_SERVICE_GROUP("ServiceGroupMapStatisticsInbound"),
    MAP_STATISTICS_SELF_SERVICE_GROUP("ServiceGroupMapStatisticsSelf"),
