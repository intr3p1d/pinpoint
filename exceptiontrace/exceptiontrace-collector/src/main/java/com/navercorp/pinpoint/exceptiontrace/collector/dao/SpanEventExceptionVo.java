...
public class SpanEventExceptionVo {
    ...
    public static SpanEventExceptionVo toSpanEventExceptionVo(SpanEventException spanEventException) {
    ...
    public static List<String> toJsonString(List<StackTraceElementWrapper> stackTrace) {
