...
public final class HbasePluginConstants {
    ...
    protected static final List<String> tableReadMethodNames = Arrays.asList("exists", "existsAll", "get", "getScanner");
    protected static final List<String> tableWriteMethodNames = Arrays.asList("append", "increment", "put", "checkAndPut", "delete", "checkAndDelete", "mutateRow", "checkAndMutate");
