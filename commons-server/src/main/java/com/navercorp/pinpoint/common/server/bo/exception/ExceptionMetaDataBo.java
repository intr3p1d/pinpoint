...
public class ExceptionMetaDataBo {
    ...
    private final List<ExceptionWrapperBo> exceptionWrapperBos;
    ...
    public ExceptionMetaDataBo(
            ...
            String uriTemplate,
            List<ExceptionWrapperBo> exceptionWrapperBos
    ) {
        ...
        this.exceptionWrapperBos = Objects.requireNonNull(exceptionWrapperBos, "exceptionWrapperBos");
    }
