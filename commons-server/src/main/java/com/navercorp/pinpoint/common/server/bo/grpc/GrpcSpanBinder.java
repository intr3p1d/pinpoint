...
public class GrpcSpanBinder {
    ...
    private static final GrpcSpanEventExceptionHandler spanEventExceptionHandler = new GrpcSpanEventExceptionHandler();
    ...
    private void bind(SpanEventBo spanEvent, PSpanEvent pSpanEvent, SpanEventBo prevSpanEvent) {
        ...
        if(pSpanEvent.hasFlushedException()) {
            ...
            spanEvent.setFlushedException(spanEventExceptionHandler.bind(pSpanEventException));
        }
    }
