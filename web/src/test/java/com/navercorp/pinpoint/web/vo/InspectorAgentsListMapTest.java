...
public class InspectorAgentsListMapTest {
    ...
    public void groupByHostNameShouldHaveContainersFirstAndGroupedSeparatelyByAgentStartTimestampDescendingOrder() {
        ...
        List<AgentsList<AgentAndStatus>> agentsLists = builder.build().getApplicationAgentLists();
    ...
    public void mergeLists() {
        ...
        List<AgentsList<AgentAndStatus>> agentsLists = builder1.build().getApplicationAgentLists();
