...
public class ServerMapHistogramController {
    ...
    @GetMapping(value = "/response", params = {
    ...
    public NodeHistogramSummaryView getResponseTimeHistogramDataV2(
            ...
            @RequestParam(value = "focusedNodeName", required = false) String focusedNodeName,
        ...
        String nodeName = focusedNodeName != null ? focusedNodeName : appForm.getApplicationName();
